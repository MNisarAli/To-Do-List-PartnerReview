...
- [Live Demo Link](https://github.com/MNisarAli/To-Do-List-PartnerReview)
...
4. Clone the repo using the below command
 > git clone  https://github.com/MNisarAli/To-Do-List-PartnerReview.git
...
Feel free to check the [issues page](https://github.com/MNisarAli/To-Do-List-PartnerReview/issues).
